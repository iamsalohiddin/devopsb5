...
print('Type of the variale num is',type(num))
print('The value of the variable num is',num)

num += 30
print('Type of the variale num is',type(num)) #int
...
num /= 2
print('Type of the variale num is',type(num)) #float
...
# Note! Once the type goes to float using any ARITHMETIC operation will not
