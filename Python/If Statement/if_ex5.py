...
# it will tell us how many small packages we should ship.
...
# Every big package is 5 kilogram and every small package is 1 kilogram.
...
# # ask B and S package numbers, ask the total goal kg of the shipment, 
 

# big_package_num = int(input("Enter amount of big packages: "))
# small_package_num = int(input("Enter amount of small packages: "))
# total_kg = int(input("What is your total goal of shipment in kg: "))

# # assign small and big packages
# small_package = 1
# big_package = 5
# # big packages needed
# big_package_amount = total_kg // big_package_num
# # kg left after filling big packages
# kg_left = total_kg % (big_package*big_package_amount)  # possible bug
# # small packages needed
# small_package_amount = kg_left // small_package
# # if it is possible to ship
# if big_package*big_package_num + small_package*small_package_num >= total_kg:
#     print("You can ship. You will need",small_package_amount,"small packages")
# elif big_package*big_package_num + small_package*small_package_num < total_kg:
#     print("You can not ship.")
